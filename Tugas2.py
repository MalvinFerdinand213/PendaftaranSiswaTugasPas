...
def delete_bio():
    print_header("-Menghapus Bio Siswa-")
    ...
    if code:
        ...
        if verify_ans(respon):
            ...
            print("Biodata telah dihapus.")
 
        else:
            print("Biodata batal dihapus")
...
def update_bio():
    print_header("Perbarui data Siswa\n")
